...
Bohy's \texttt{A}ntichain
\texttt{a}nd \texttt{P}seudo-\texttt{A}ntichain \texttt{L}ibrary \cite{aapal}
...
\subsubsection{Operations implementation}

add element to antichain: uses compare
